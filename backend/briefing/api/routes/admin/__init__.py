...
from briefing.api.routes.admin.bills import router as bills_router
...
from briefing.api.routes.admin.media import router as media_router
from briefing.api.routes.admin.officials import router as officials_router
from briefing.api.routes.admin.ops import router as ops_router
from briefing.api.routes.admin.opinions import router as opinions_router
